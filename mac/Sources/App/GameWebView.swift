...
final class WebViewCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    ...
    /// why, without this, tapping the GitHub or Tahoe5 link does nothing at all.
    func webView(_ webView: WKWebView,
    ...
    func webView(_ webView: WKWebView,
        ...
        NSLog("[Tahoe21] provisional navigation failed: \(error)")
    }

    func webView(_ webView: WKWebView, didFail navigation: WKNavigation!, withError error: Error) {
        NSLog("[Tahoe21] navigation failed: \(error)")
    }

    func webViewWebContentProcessDidTerminate(_ webView: WKWebView) {
        NSLog("[Tahoe21] web content process terminated — reloading")
        webView.reload()
    }
